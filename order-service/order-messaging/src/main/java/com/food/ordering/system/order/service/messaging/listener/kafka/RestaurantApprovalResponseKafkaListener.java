...
import com.food.ordering.system.order.service.domain.ports.input.message.listner.restaurantapproval.RestaurantApprovalResponseMessageListener;
...
public class RestaurantApprovalResponseKafkaListener implements KafkaConsumer<RestaurantApprovalResponseAvroModel> {
    ...
    /*
     * Kafkaからメッセージ(Avro形式)を受け取り、ドメイン層のListenerに受け渡す。
     */
    @Override
    ...
    public void receive(
        ...
        messages.forEach(restaurantApprovalResponseAvroModel -> {
            if (OrderApprovalStatus.APPROVED == restaurantApprovalResponseAvroModel.getOrderApprovalStatus()) {
                ...
                restaurantApprovalResponseMessageListener.orderApproval(
