...
public class RestaurantApprovalResponseAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private java.util.List<java.lang.String> failureMessage;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 6: failureMessage = (java.util.List<java.lang.String>)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public java.util.List<java.lang.String> getFailureMessage() {
   ...
   * @param value the value to set.
   */
  public void setFailureMessage(java.util.List<java.lang.String> value) {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RestaurantApprovalResponseAvroModel>
    ...
    private Builder(com.food.ordering.system.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder other) {
      ...
      if (isValidValue(fields()[6], other.failureMessage)) {
        this.failureMessage = data().deepCopy(fields()[6].schema(), other.failureMessage);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.food.ordering.system.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder setFailureMessage(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.food.ordering.system.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder clearFailureMessage() {
      failureMessage = null;
    ...
    public RestaurantApprovalResponseAvroModel build() {
      try {
        ...
        record.failureMessage = fieldSetFlags()[6] ? this.failureMessage : (java.util.List<java.lang.String>) defaultValue(fields()[6]);
        return record;
