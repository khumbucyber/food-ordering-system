...
public class PaymentDomainServiceImpl implements PaymentDomainService{
    ...
    public PaymentEvent validateAndInitiatePayment(Payment payment,
        ...
        if (failureMessages.isEmpty()) {
            ...
            return new PaymentCompletedEvent(payment, ZonedDateTime.now(ZoneId.of(DomainConstants.UTC)), paymentCompletedEventPublisher);
        } else {
    ...
    public PaymentEvent validateAndCancelPayment(Payment payment,
        ...
        if (failureMessages.isEmpty()) {
            ...
            return new PaymentCancelledEvent(payment, ZonedDateTime.now(ZoneId.of(DomainConstants.UTC)), paymentCancelledEventPublisher);
        } else {
            log.error("Payment for order: {} cancellation failed", 
                    payment.getOrderId().getValue());
            payment.updateStatus(PaymentStatus.FAILED);
            return new PaymentFailedEvent(payment, ZonedDateTime.now(), failureMessages, paymentFailedEventPublisher);
        }
    }
